...
def run_game():
	...
	while running:
		...
		for event in pygame.event.get():
			...
			#WSAD
			elif event.key == K_w: player.k_up = down * 2
			elif event.key == K_s: player.k_down = down * -2
			elif event.key == K_d: player.k_right = down * -10
			elif event.key == K_a: player.k_left = down * 10
